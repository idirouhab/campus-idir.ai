        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              isDevelopment
                ? "connect-src 'self' http://127.0.0.1:* http://localhost:* https://*.google-analytics.com https://*.googletagmanager.com https://*.sentry.io https://*.supabase.co https://cloudflareinsights.com"
                : "connect-src 'self' https://*.google-analytics.com https://*.googletagmanager.com https://*.sentry.io https://*.supabase.co https://cloudflareinsights.com",
